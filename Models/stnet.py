...
class STNET(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        # Spatially downsample context to fit with next temporal pooling layer
        sampled_context1 = self.downsample_context(context1,batches,32,16,context_dim=64) # Output: (batches*16*16,64)
        ...
        # Spatially downsample context to fit with next temporal pooling layer
        sampled_context2 = self.downsample_context(context2,batches,16,8,context_dim=64) # Output: (batches*8*8,64)
